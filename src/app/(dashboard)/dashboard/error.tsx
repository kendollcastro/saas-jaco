...
export default function DashboardError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h2 className="text-foreground text-xl font-extrabold mb-2">Error del dashboard</h2>
      <p className="text-muted-foreground text-sm mb-6 max-w-sm">Algo salió mal al cargar los datos.</p>
      <button
        onClick={reset}
